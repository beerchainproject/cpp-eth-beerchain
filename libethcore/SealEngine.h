...
////////////////////////////////////////////////////////////// // beerchain
	void setBeerchainSchedule(EVMSchedule _beerchainSchedule) const { beerchainSchedule = _beerchainSchedule; }

	EVMSchedule& getBeerchainSchedule() const { return beerchainSchedule; }
...
private:
	...
	mutable EVMSchedule beerchainSchedule; // beerchain
