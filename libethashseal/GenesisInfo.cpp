...
#include "genesis/beerchainMainNetwork.cpp"
...
#include "genesis/test/beerchainTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::beerchainMainNetwork: return c_genesisInfoBeerchainMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::beerchainTestNetwork: return c_genesisInfoBeerchainTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::beerchainMainNetwork: return c_genesisStateRootBeerchainMainNetwork;
    case Network::beerchainTestNetwork: return c_genesisStateRootBeerchainTestNetwork;
